...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="max-w-[100%] mx-auto p-2 sm:p-6 bg-white text-gray-700 shadow-md rounded-lg">
            <div className="my-6">
                <h2 className="text-xl font-bold text-blue-600 flex"><span><ArrowLeft size={20} className="mt-1 mx-2" /></span>Create Customer </h2>
                <p className="ml-10 text-sm text-gray-600"> Add a new Customer</p> 
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4">
                                <h3 className="text-lg font-medium mr-4">Shipping Address</h3>
                                <div className="text-sm text-blue-600 gap-2 hover:text-blue-700 font-medium flex items-center cursor-pointer" id="copy_address">
                                    <Copy size={14}/>
                                    Copy from Billing
                                </div>
                            </div>

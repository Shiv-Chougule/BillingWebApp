...
const Invoice = ({invoices, invoiceID}) => {
    ...
    if (!invoice) {
        return <div className="text-center p-8">No invoice selected</div>;
    }

    if (loading) {
        return <div className="text-center p-8">Loading invoice details...</div>;
    }
  ...
  const calculatedTotal = calculatedSubTotal + (invoice.adjustment || 0);
  const amountInWords = toWords(calculatedTotal || 0);

    return (
        <div className="w-6xl h-full mx-auto bg-white border-1 text-black p-6">
            {/* Header */}
            ...
            {/* Title */}
            <h1 className="text-xl font-bold">PERFORMA INVOICE</h1>
            ...
            <div className="bg-gray-300 p-2 flex justify-between text-sm">
                ...
                <div>
                    <p>Validity Date: {new Date(invoice.dueDate).toLocaleDateString()}</p>
                </div>
            </div>
            ...
            <div className="w-[50%] mb-4 border-1 border-gray-300">
                ...
                <p className="text-blue-600 font-medium m-2">{invoice.customer?.customerName}</p>
            </div>
            ...
            <div className="flex justify-between">
                ...
                <div className="flex justify-between border-b border-gray-300">
                    ...
                    <div className="flex justify-between border-b border-gray-300">
                        ...
                        <span>{invoice.adjustment?.toLocaleString() || '0'}</span>
                    </div>
                    <div className="flex justify-between border-b border-gray-300">
                        <span>Total : </span>
